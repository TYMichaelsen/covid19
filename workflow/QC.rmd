...
# For build mode.
batch     <- "CJ060"
labmeta   <- "/srv/rbd/covid19/processing/CJ060_test2/sample_sheet.csv"
input_dir <- "/srv/rbd/covid19/processing/CJ060_test2"
...
- `Fail`: A genome with either 1) >5000 N's in total or 2) <5x coverage.
- `Dropout`: A genome with >5x coverage and >5000 N's.
...
## Coverage for specific samples

```{r}
meta_sub <- filter(d,sample_type == "sample" & genome_qc == "Fail" & coverage > 1000)
LIB-CJ060-135
```
