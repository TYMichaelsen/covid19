...
p1 <- p + geom_treescale() +
    geom_tiplab(align = T, linesize = .25, size = 3, aes(color = genome_qc), 
                offset = 0.00015, fontface = "bold", hjust = 1) +
...
gheatmap(p1, snv_heat2, colnames_angle = 90, hjust = 1, font.size = 2, offset = 0.00008, width = 0.8) +
...
gheatmap(p1, freq_heat2, colnames_angle = 90, hjust = 1, font.size = 2, offset = 0.00004, width = 0.8) +
