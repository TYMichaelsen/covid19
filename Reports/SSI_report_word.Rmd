...
timestmp_ll <- "2020-10-22"
path_to_ll  <- "/srv/rbd/covid19/metadata/raw-ssi-metadata/Lineliste_221020.xlsx"
...
meta_all <- mutate(meta_all,
  ...
  firstDayWeek = {floor_date(date_consensus,"week") + 1} %>% as.Date(),
...
d_clades_week <- filter(meta_all, !is.na(clade)) %>%
